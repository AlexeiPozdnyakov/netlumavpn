...
struct TunnelSettingsView: View {
    ...
    private var onDemandHelpText: String {
        if preferences.persistTunnel {
            L10n.string("Connect On Demand can reconnect automatically when the tunnel drops.")
        } else {
            L10n.string("Enable Persist Tunnel before using On Demand.")
        }
    }
}
...
private struct ToggleRow: View {
    ...
    var body: some View {
        ...
        .toggleStyle(SwitchToggleStyle(tint: NetlumaVPNTheme.accent))
