...
struct ToggleVPNConnectionIntent: AppIntent {
    ...
    static var description = IntentDescription("Connects or disconnects the selected QuickVPN profile.")
...
struct ConnectVPNConnectionIntent: AppIntent {
    ...
    static var description = IntentDescription("Connects the selected QuickVPN profile.")
    static var openAppWhenRun = false
...
struct DisconnectVPNConnectionIntent: AppIntent {
    ...
    static var description = IntentDescription("Disconnects the active QuickVPN tunnel.")
    static var openAppWhenRun = false
