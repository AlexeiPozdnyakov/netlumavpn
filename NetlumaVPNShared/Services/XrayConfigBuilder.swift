...
enum XrayConfigBuilderError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .missingRealityPublicKey:
            L10n.string("Reality public key is missing.")
        case .missingWireGuardPeerPublicKey:
            L10n.string("WireGuard peer public key is missing.")
        case .missingWireGuardAddress:
            L10n.string("WireGuard interface address is missing.")
        case .invalidJSON:
            L10n.string("Could not build Xray JSON configuration.")
        }
    }
}
