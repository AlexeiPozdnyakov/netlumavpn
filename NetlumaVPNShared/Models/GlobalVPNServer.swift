...
struct GlobalVPNServer: Identifiable, Codable, Equatable, Hashable {
    ...
    init(from decoder: Decoder) throws {
        ...
        configFormat = try container.decodeIfPresent(String.self, forKey: .configFormat) ?? "uri"
...
struct GlobalServerProfileIssue: Codable, Equatable {
    ...
    var requiresConfigDownload: Bool {
        configFormat != "uri" || configURL.lowercased().hasPrefix("http://") || configURL.lowercased().hasPrefix("https://")
    }
}
