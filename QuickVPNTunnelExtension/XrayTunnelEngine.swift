...
enum XrayTunnelEngineError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .invalidGeneratedConfig:
            "The generated Xray configuration is invalid."
        case .engineUnavailable:
            "The real Xray engine is not linked into this build."
        case .configStringEncodingFailed:
            "The generated Xray configuration could not be converted to text."
        }
    }
}
