...
struct CapsuleIconButtonStyle: ButtonStyle {
    var tint: Color = QuickVPNTheme.card
...
struct QuickVPNCard<Content: View>: View {
    let content: Content
    ...
    var body: some View {
        content
            .background(QuickVPNTheme.card, in: RoundedRectangle(cornerRadius: 16, style: .continuous))
            .overlay {
