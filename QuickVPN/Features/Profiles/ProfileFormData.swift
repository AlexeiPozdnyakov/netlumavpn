...
enum ProfileFormError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .missingPassword:
            "Enter the password."
        case .missingRealityPublicKey:
            "Enter the Reality public key."
        case .missingWireGuardPrivateKey:
            "Enter the WireGuard private key."
        case .missingWireGuardPeerPublicKey:
            "Enter the WireGuard peer public key."
        case .missingWireGuardAddress:
            "Enter at least one WireGuard interface address."
        case .invalidWireGuardKeepAlive:
            "Enter a valid WireGuard keepalive value."
        case .invalidWireGuardMTU:
            "Enter a valid WireGuard MTU from 576 to 9000."
        case .invalidWireGuardReserved:
            "Enter WireGuard reserved bytes as comma-separated values from 0 to 255."
        }
    }
}
